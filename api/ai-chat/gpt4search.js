module.exports = {
    name: "GPT-4o Search",
    desc: "Chat dengan GPT-4o + web search realtime via NekoLabs.",
    category: "AI CHAT",
    method: "GET",
    ...
    async run(req, res) {
        ...
        try {
            const url  = `https://rynekoo-api.hf.space/text.gen/gpt/4o-search?text=${encodeURIComponent(text)}&systemPrompt=${encodeURIComponent(systemPrompt)}&sessionId=${encodeURIComponent(sessionId)}`;
