module.exports = {
    ...
    desc: "Chat dengan GPT-4o Mini + web search realtime lebih cepat.",
    category: "AI CHAT",
    method: "GET",
    ...
    async run(req, res) {
        ...
        try {
            const url  = `https://rynekoo-api.hf.space/text.gen/gpt/4o-mini-search?text=${encodeURIComponent(text)}&systemPrompt=${encodeURIComponent(systemPrompt)}&sessionId=${encodeURIComponent(sessionId)}`;
