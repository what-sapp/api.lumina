...
async function gptoss(prompt, system = "") {
    const chatHistory = [];
    ...
    form.append("model", "gpt-oss-120b");
...
if (require.main === module) {
    ...
    if (!prompt) { console.log('Usage: node gptoss.js "pertanyaan" ["system"]'); process.exit(1); }
    gptoss(prompt, system)
