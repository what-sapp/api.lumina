module.exports = {
    name: "GPT-4.1 Nano",
    desc: "Chat dengan GPT-4.1 Nano via NekoLabs, support vision (image URL).",
    category: "AI CHAT",
    method: "GET",
    ...
    async run(req, res) {
        ...
        try {
            let url = `https://rynekoo-api.hf.space/text.gen/gpt/4.1-nano?text=${encodeURIComponent(text)}&systemPrompt=${encodeURIComponent(systemPrompt)}&sessionId=${encodeURIComponent(sessionId)}`;
