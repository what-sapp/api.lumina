...
const CONFIG = {
    API_URL: 'https://api.snowping.my.id/api/imageai/toanime',
...
const utils = {
    ...
    uploadToCloud: async (imageUrl, filenamePrefix = 'toanime') => {
        try {
...
const processToAnime = async (imageUrl) => {
    try {
        console.log(`🎨 Starting Image to Anime conversion...`);
...
module.exports = {
    name: "To Anime",
    desc: "Convert image to anime style using AI",
    ...
    async run(req, res) {
        try {
            ...
            const result = await processToAnime(imageUrl);
